...
async def generate_iac_code(
    ...
    try:
        result = generate_iac(
            ...
            iam_mode=body.iam_mode,
            enable_provisioning=body.enable_provisioning,
            enable_model_activation=body.enable_model_activation,
            enable_cost_tracking=body.enable_cost_tracking,
