...
GROQ_MODELS: List[ModelInfo] = [
    ...
    ModelInfo(id="groq-2a", name="GPT OSS 120B", provider="groq", provider_model_id="openai/gpt-oss-120b", capabilities=["text", "code", "function_calling"], context_window=131072, pricing_tier="economy", input_price_per_1k=0.00015, output_price_per_1k=0.0006),
    ModelInfo(id="groq-2b", name="GPT OSS 20B", provider="groq", provider_model_id="openai/gpt-oss-20b", capabilities=["text", "code", "function_calling"], context_window=131072, pricing_tier="economy", input_price_per_1k=0.000075, output_price_per_1k=0.0003),
