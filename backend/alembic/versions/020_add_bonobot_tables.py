...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("max_session_messages", sa.Integer(), nullable=False, server_default="200"),
        sa.Column("rate_limit_rpm", sa.Integer(), nullable=False, server_default="30"),
        sa.Column("budget_alert_threshold", sa.Numeric(precision=3, scale=2), nullable=False, server_default="0.8"),
        sa.Column("status", sa.String(20), nullable=False, server_default="active"),
